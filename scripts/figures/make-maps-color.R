...
# plot standardized sentencing rates with confidence intervals ====
...
save_tmap(tm = plantation_map_bw,
          filename = "figures/plantation-belt-bw.png",
          units = "in", width = 6)
...
fl$SIR_zero_cntr <- fl$SIR - 1 # for color scale
