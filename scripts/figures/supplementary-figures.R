...
ggsave("shrinkage.png",path = "LABOR-01-13-2019/Appendix/figures")
...
tmap_save(tm = cluster_map,
          filename = "LABOR-01-13-2019/Appendix/figures/cluster-map.png",
          units = "in", width = 6.75)
...
tmap_save(tm = aple_map,
          filename = "LABOR-01-13-2019/Appendix/figures/aple-map.png",
          units = "in", width = 6.75)
...
tmap_save(tm = raw_ssr,
          filename = "LABOR-01-13-2019/Appendix/figures/raw-ssr.png",
          units = "in", width = 6.75)

tmap_save(tm = ssr,
          filename = "LABOR-01-13-2019/Appendix/figures/supplementary-ssr.png",
          units = "in", width = 6.75)
